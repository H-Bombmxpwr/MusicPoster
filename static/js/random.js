...
document.addEventListener('DOMContentLoaded', function () {
    ...
    "1989.png",
    "3_feet_high.png",
    "A$AP_Ferg_Floor_Seats.png",
    "A_Seat_at_the_Table.png",
    "Alexandra_Stan_Saxobeats.png",
    "Amen_.png",
    "Arctic_Monkeys_AM.png",
    "Ava_Max_Heaven_&_Hell.png",
    "Baduizm.png",
    "Berhana.png",
    "Big_Ideas.png",
    "Billy_Joel_Glass_Houses.png",
    "Blood_Sugar_Sex_Magik_.png",
    "Blue_Moves.png",
    "Brothers.png",
    "Bruce_Springsteen_Born_In_The_U.S.A..png",
    "California_.png",
    "ChappellRoan_poster.png",
    "Chappell_Roan_The_Rise_and_Fall_of_a_Midwest_Princess.png",
    "Charli_xcx_BRAT.png",
    "Charlie_Puth_Nine_Track_Mind.png",
    ...
    "El_Camino.png",
    "Ella_Langley_Choosin_Texas.png",
    "Eternal_Atake.png",
    "FALLING_OR_FLYING_.png",
    "Flo_Rida_Wild_Ones.png",
    "Freudian.png",
    "Funkentelechy_Vs._The_Placebo_Syndrome.png",
    "G-Eazy_When_Its_Dark_Out.png",
    "GINGER.png",
    "Gemini_Rights.png",
    "Gracie_Abrams_Good_Riddance.png",
    "Gracie_Abrams_The_Secret_of_Us_.png",
    "Honky_Chateau.png",
    "Hot_Chelle_Rae_Whatever.png",
    "I_Never_Loved_a_Man_the_Way_I_Love_You.png",
    "Im_Just_Ken_.png",
    "Indigo_Jack__The_New_World_Border.png",
    "Justin_Timberlake_The_20_20_Experience.png",
    "KIDS_SEE_GHOSTS.png",
    "Kanye_West_Graduation.png",
    "Kendrick_Lamar_GNX.png",
    "Kesha_Animal.png",
    "La_Roux_La_Roux.png",
    "Lady_Gaga_MAYHEM.png",
    "Late_Registration.png",
    "Laufey_A_Matter_of_Time.png",
    "Led_Zeppelin_Physical_Graffiti.png",
    "Lets_Rock.png",
    "Luke_Combs_Aint_No_Love_In_Oklahoma_.png",
    "MANIA.png",
    "MAX_LOVE_IN_STEREO.png",
    "MM...FOOD.png",
    "MONTERO.png",
    "Macadelic.png",
    ...
    "My_Chemical_Romance_The_Black_Parade.png",
    "Next_Rated_Next.png",
    "One_Wayne_G.png",
    ...
    "SOUR.png",
    "Scarlet.png",
    "Shakira_Oral_Fixation,_Vol._2.png",
    "Short_n_Sweet.png",
    "StaySolidRocky_Fallin.png",
    "Suddenly_.png",
    "Tate_McRae_SO_CLOSE_TO_WHAT.png",
    "Tha_Carter_III.png",
    "The_2nd_Law.png",
    "The_Beatles_1_.png",
    "The_Beginning.png",
    ...
    "The_Swing.png",
    "The_Trinity.png",
    "Third_Eye_Blind_Third_Eye_Blind.png",
    "Time_Space.png",
    "Turn_Blue.png",
    "Twenty_One_Pilots_Blurryface.png",
    "Ugh_those_feels_again.png",
    "Valley_Last_Birthday.png",
    "Van_Halen_1984.png",
    ...
    "Wasteland,_Baby!.png",
    "Yours_Dreamily.png",
    "Yung_Bleu_Moon_Boy.png",
    "Zach_Top_Cold_Beer_&_Country_Music.png",
    ...
    "in_utero.png",
    "innerspeaker.png",
    "jschlatt_A_Very_1999_Christmas.png",
    "justice.png",
    "kick.png",
    "l-o-v-e.png",
